package com.kodlamaio.inventoryservice.api.cotrollers;
...
public class CarsController {
    ...
    @GetMapping
    //Secured,PreAuthorize,PostAuthorize,PostFilter,PreFilter
    //@Secured("ROLE_admin")
    //@PreAuthorize("hasAnyRole('user','admin')") //SPel kullanılabilir
